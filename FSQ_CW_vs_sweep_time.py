...
def measure(ts_vec,exp,station,current_point=0):
    ...
    meas.register_parameter(FSQ.spectrum,setpoints=[FSQ.sweep_time_direct])
...
description='FSQ_CW_vs_SWEEP_TIME'
...
FSQ_ratio  = np.logspace(-1, 4 , 50)
# FSQ_ratio          = np.ones(20)
FSQ_time_sweep_vec = 1./(FSQ_vbw) * FSQ_npt * FSQ_ratio
