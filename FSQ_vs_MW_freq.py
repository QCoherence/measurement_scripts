# Script to measure FSQ trace vs MW source frequency
#                            -- Dorian
...
def measure_vs_frequency(srcfrq_vec,exp,station,current_point=0):
    ...
    with meas.run() as datasaver:
        ...
        for f in srcfrq_vec:
            ...
            datasaver.add_result((FSQ.freq_axis, FSQ.freq_axis()),(FSQ.spectrum,FSQ.spectrum()),(MW_source.frequency,get_f))
...
description='FSQ_vs_MW_frequency'
...
f_center = 3.                    #GHz
f_span   = 0.1                   #GHz
f_start  = f_center - f_span/2.  #GHz
f_stop   = f_center + f_span/2.  #GHz
f_step   = 0.0005               #GHz
# f_step = 0.05
...
FSQ_time_sweep = 1./FSQ_vbw * FSQ_npt * 100 * 1000
...
print('\ntime estimation for all measurement : {} '
      .format(datetime.timedelta(seconds=FSQ_time_sweep * f_points)))
...
FSQ.detector('rms')
FSQ.sweep_time_direct(FSQ_time_sweep)
