...
def do1d(
    ...
    *param_meas: ParamMeasT,
    ...
    show_progress: Optional[None] = True,
    log_info: Optional[str] = None,
) -> AxesTupleListWithDataSet:
    """
...
def formatString(stringname):
    # this function formats the string in a QCodes name compatible way
    return stringname.replace('+', '').replace('.','_')