...
def measure(freq_vec, exp, station,current_point=0.):
...
print('\ntime estimation for all measurement : {} '
      .format(datetime.timedelta(seconds=2*SA_avg*freq_points*SA_time_sweep)))
...
measure(src_freq_vec,exp=exp, station=station,current_point=current)
